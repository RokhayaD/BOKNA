    ...
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        >
          ...
          <option value="MAYOR_CANDIDACY">Me présenter comme maire (coalition Bokna)</option>
        </select>
      </div>
        ...
        <textarea
          ...
          placeholder={
            type === "MAYOR_CANDIDACY"
              ? "Présentez votre parcours, votre vision pour la commune et vos motivations à représenter la coalition Bokna..."
